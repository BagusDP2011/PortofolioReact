    ...
    <div id="workExp">
      ...
      >
        ...
        >
          ...
          <GridItem>
            <Text>4. Miniflix</Text>
            <Image
              src={require("../assets/projek/projek miniflix.jpg")}
              alt="Projek Miniflix"
              width={{ lg: "480px", md: "360px", sm: "250px", base: "100px" }}
              height={{ lg: "200px", md: "150px", sm: "250px", base: "70px" }}
            ></Image>
            <br />
            <Text>Last updated: Ongoing Project. Not finished.</Text>
            <Text>
              <a href="https://miniflix-nine.vercel.app/">
              <u>https://miniflix-nine.vercel.app/</u>
              </a>
            </Text>
          </GridItem>
        </Grid>
